        ...
        <div class="row justify-content-center">
            ...
            <div class="col-auto mb-5">
                <div class="card text-center">
                    <img src="images/event.PNG" class="card-img-top" alt="Social Event">
                    <div class="card-body">
            ...
            <div class="col-auto mb-5 mx-5">
                <div class="card text-center">
                    <img src="images/Ac.PNG" class="card-img-top" alt="Social Image">
                    <div class="card-body">
                        <h5 class="card-title"></h5>
            ...
            <div class="col-auto mb-5">
                <div class="card text-center">
                    <img src="images/intern.PNG" class="card-img-top" alt="Advertisement Photo">
                    <div class="card-body">
                        <!-- <h5 class="card-title"></h5> -->
                        <p class="card-text">Manage exclusive job listings, workshops, seminars to nurture others' professional growth</p>
                    </div>
                    <div class="d-grid gap-2"> <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="manage_advertisements.php">Post Internship/Jobs</a> </div>
                </div>
            </div>
        </div>
