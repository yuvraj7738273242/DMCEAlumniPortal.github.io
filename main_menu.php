        ...
        <div class="row justify-content-center">
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    <img src="images/alumni.PNG  " class="card-img-top" alt="Social Image">
                    <div class="card-body">
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    ...
                    <div class="d-grid gap-2"> <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="view_advertisements.php">View Internship/Jobs</a> </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    <img src="images/pro.PNG" class="card-img-top" alt="Profile Picture">
                    <div class="card-body">
